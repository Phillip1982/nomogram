...
knitr::kable(kitchen.sink.model.stats, caption = "Performance statistics of the Kitchen Sink Model Using All Variables")
```
...
#lrm.with.lasso.variables$stats  #Shows the C-statistic and the Brier score.  
train.model.stats <- as.data.frame(lrm.with.lasso.variables$stats)
knitr::kable(train.model.stats, caption = "Performance statistics of the Training Model")
```
...
knitr::kable(test.model.stats, caption = "Performance statistics of the Testing Model")
```
