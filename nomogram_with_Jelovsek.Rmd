...
This allowed for measuring the associations between continuous predictors using a matrix with correlation coefficients. The scatterplot matrix of a sample of predictors below demonstrated some associations. CAN WE INCLUDE ONLY CONTINUOUS VARIABLES?

```{r, include = TRUE, fig.width=8, fig.height=4}
train.df <- train
psych::pairs.panels(train.df[, c(9:15)], bg=c("red","blue")[as.factor(train.df$Match_Status)], pch=21, jiggle = TRUE)
```
