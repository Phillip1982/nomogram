...
1. x of the variables were a continuous real number [0,100] and contained attributes a type of word frequency (ie. 100 * (number of times the WORD appears in the e-mail) / total number of words in e-mail.)
